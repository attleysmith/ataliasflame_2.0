...
import static com.asgames.ataliasflame.domain.services.magic.spells.summon.Summonings.ANIMALS;
...
public class CallingAnimals extends SpellEffect {
    ...
    private static final List<SelectionValue<Optional<CompanionTemplate>>> ANIMAL_SELECTOR = List.of(
            new SelectionValue<>(1, Optional.empty()),
            new SelectionValue<>(9, Optional.of(ANIMALS.get(TAMED_FALCON))),
