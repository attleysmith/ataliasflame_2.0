...
create table character (name varchar(255) not null, attack integer, attribute_points integer, caste varchar(255), damage_multiplier integer, defense integer, defensive_god varchar(255), experience integer, gender varchar(255), initiative integer, injury integer, level integer, max_damage integer, min_damage integer, race varchar(255), total_health integer, weapon_code varchar(255), weapon_defense integer, weapon_initiative integer, weapon_max_damage integer, weapon_min_damage integer, primary key (name));
