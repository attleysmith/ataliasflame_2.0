...
public class ClericToNatureDwellerEnduranceTest extends EnduranceTestBase {
    ...
    private void level5Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(71));
    }
    ...
    private void level56Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(840));
    }
    ...
    private void level90Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(1375));
    }
