...
public class ClericToSorcererEnduranceTest extends EnduranceTestBase {
    ...
    private void level56Upgrade() {
        ...
        // expect
        assertThat(character.getCaste(), is(SAINT));
        // and
        ...
        assertThat(character.getTotalMagicPoint(), is(871));
    }
    ...
    private void level90Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(1518));
    }
