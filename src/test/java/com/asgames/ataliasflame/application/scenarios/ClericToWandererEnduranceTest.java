...
public class ClericToWandererEnduranceTest extends EnduranceTestBase {
    ...
    private void level20Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(262));
    }
    ...
    private void level56Upgrade() {
        ...
        // then
        upgradeCaste(APOSTLE);

        // expect
        assertThat(character.getCaste(), is(APOSTLE));
    ...
    private void level90Upgrade() {
        ...
        assertThat(character.getTotalHealth(), is(1130));
        assertThat(character.getTotalMagicPoint(), is(445));
    }
