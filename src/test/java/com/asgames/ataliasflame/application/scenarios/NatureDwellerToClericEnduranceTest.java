...
public class NatureDwellerToClericEnduranceTest extends EnduranceTestBase {
    ...
    private void level5Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(69));
    }
    ...
    private void level20Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(280));
    }
    ...
    private void level56Upgrade() {
        ...
        // expect
        assertThat(character.getCaste(), is(SHAMAN));
        // and
    ...
    private void level90Upgrade() {
        ...
        // then
        addAttributePoints(INTELLIGENCE, 1);
        addAttributePoints(MENTAL_POWER, 4);
