...
public class NatureDwellerToSorcererEnduranceTest extends EnduranceTestBase {
    ...
    private void level57Upgrade() {
        ...
        // then
        addAttributePoints(SPIRITUAL_POWER, 5);
        ...
        assertThat(character.getTotalMagicPoint(), is(875));
    }
    ...
    private void level90Upgrade() {
        ...
        assertThat(character.getTotalHealth(), is(510));
        assertThat(character.getTotalMagicPoint(), is(1520));
    }
