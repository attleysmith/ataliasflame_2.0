...
public class NatureDwellerToWandererEnduranceTest extends EnduranceTestBase {
    ...
    private void level20Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(229));
    }
    ...
    private void level55Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(405));
    }
    ...
    private void level90Upgrade() {
        ...
        assertThat(character.getDamageMultiplier(), is(242));
        assertThat(character.getTotalHealth(), is(1120));
        assertThat(character.getTotalMagicPoint(), is(425));
    }
