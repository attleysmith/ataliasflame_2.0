...
public class NatureDwellerToWarriorEnduranceTest extends EnduranceTestBase {
    ...
    private void level20Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(239));
    }
    ...
    private void level59Upgrade() {
        ...
        // then
        addAttributePoints(LORE, 1);
        addAttributePoints(SPIRITUAL_POWER, 4);
        ...
        assertThat(character.getTotalMagicPoint(), is(490));
    }
