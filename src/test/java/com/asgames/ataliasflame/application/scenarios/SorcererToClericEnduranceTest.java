...
public class SorcererToClericEnduranceTest extends EnduranceTestBase {
    ...
    private void level20Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(370));
    }
    ...
    private void level56Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(925));
    }
