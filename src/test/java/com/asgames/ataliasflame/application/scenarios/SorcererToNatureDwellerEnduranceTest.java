...
public class SorcererToNatureDwellerEnduranceTest extends EnduranceTestBase {
    ...
    private void level5Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(93));
    }
    ...
    private void level57Upgrade() {
        ...
        // then
        upgradeCaste(WITCH_DOCTOR);

        // expect
        assertThat(character.getCaste(), is(WITCH_DOCTOR));
        // and
        ...
        assertThat(character.getTotalMagicPoint(), is(996));
    }
    ...
    private void level90Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(1462));
    }
