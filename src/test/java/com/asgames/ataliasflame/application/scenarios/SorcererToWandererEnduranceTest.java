...
public class SorcererToWandererEnduranceTest extends EnduranceTestBase {
    ...
    private void level20Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(335));
    }
    ...
    private void level56Upgrade() {
        ...
        // then
        upgradeCaste(CHARLATAN);

        // expect
        assertThat(character.getCaste(), is(CHARLATAN));
        ...
        assertThat(character.getTotalMagicPoint(), is(465));
    }
