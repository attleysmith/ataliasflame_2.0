...
public class SorcererToWarriorEnduranceTest extends EnduranceTestBase {
    ...
    private void level21Upgrade() {
        ...
        // then
        addAttributePoints(STRENGTH, 1);
        addAttributePoints(CONSTITUTION, 4);
    ...
    private void level55Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(522));
    }
    ...
    private void level89Upgrade() {
        ...
        // then
        addAttributePoints(STRENGTH, 2);
        addAttributePoints(CONSTITUTION, 3);
    ...
    private void level90Upgrade() {
        ...
        assertThat(character.getAttributes().get(SPIRITUAL_POWER), is(10));
        // and
        assertThat(character.getAttack(), is(298));
