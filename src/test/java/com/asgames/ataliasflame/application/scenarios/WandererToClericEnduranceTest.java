...
public class WandererToClericEnduranceTest extends EnduranceTestBase {
    ...
    private void level56Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(485));
    }
    ...
    private void level90Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(1260));
    }
