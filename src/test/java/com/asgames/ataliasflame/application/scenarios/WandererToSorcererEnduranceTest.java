...
public class WandererToSorcererEnduranceTest extends EnduranceTestBase {
    ...
    private void level56Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(475));
    }
    ...
    private void level90Upgrade() {
        ...
        assertThat(character.getTotalHealth(), is(510));
        assertThat(character.getTotalMagicPoint(), is(1435));
    }
