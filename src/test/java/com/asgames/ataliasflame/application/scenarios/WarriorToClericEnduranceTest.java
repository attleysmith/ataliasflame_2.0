...
public class WarriorToClericEnduranceTest extends EnduranceTestBase {
    ...
    private void level59Upgrade() {
        ...
        // then
        upgradeCaste(CRUSADER);

        // expect
        assertThat(character.getCaste(), is(CRUSADER));
        // and
        assertThat(character.getAttack(), is(208));
        assertThat(character.getDamageMultiplier(), is(143));
    ...
    private void level90Upgrade() {
        ...
        assertThat(character.getDamageMultiplier(), is(149));
