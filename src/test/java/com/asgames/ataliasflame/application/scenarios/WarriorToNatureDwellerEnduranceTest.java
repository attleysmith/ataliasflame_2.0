...
public class WarriorToNatureDwellerEnduranceTest extends EnduranceTestBase {
    ...
    private void level20Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(89));
    }
    ...
    private void level59Upgrade() {
        ...
        // then
        upgradeCaste(BARBARIAN);

        // expect
        assertThat(character.getCaste(), is(BARBARIAN));
        // and
        assertThat(character.getAttack(), is(191));
        assertThat(character.getDamageMultiplier(), is(155));
        assertThat(character.getTotalHealth(), is(700));
        assertThat(character.getTotalMagicPoint(), is(460));
    }
    ...
    private void level90Upgrade() {
        ...
        assertThat(character.getTotalMagicPoint(), is(1150));
    }
