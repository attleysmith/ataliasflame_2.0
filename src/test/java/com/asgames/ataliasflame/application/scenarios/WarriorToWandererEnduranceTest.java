...
public class WarriorToWandererEnduranceTest extends EnduranceTestBase {
    ...
    private void level53Upgrade() {
        ...
        // then
        upgradeCaste(CHAMPION);

        // expect
        assertThat(character.getCaste(), is(CHAMPION));
        ...
        assertThat(character.getTotalMagicPoint(), is(255));
    }
    ...
    private void level75Upgrade() {
        ...
        assertThat(character.getAttributes().get(LORE), is(20));
        assertThat(character.getAttributes().get(MENTAL_POWER), is(10));
        assertThat(character.getAttributes().get(SPIRITUAL_POWER), is(45));
    }
    ...
    private void level78Upgrade() {
        ...
        assertThat(character.getAttributes().get(LORE), is(20));
        assertThat(character.getAttributes().get(MENTAL_POWER), is(10));
        assertThat(character.getAttributes().get(SPIRITUAL_POWER), is(51));
    }
    ...
    private void level81Upgrade() {
        ...
        assertThat(character.getAttributes().get(LORE), is(20));
        assertThat(character.getAttributes().get(MENTAL_POWER), is(10));
        assertThat(character.getAttributes().get(SPIRITUAL_POWER), is(57));
    }
    ...
    private void level84Upgrade() {
        ...
        assertThat(character.getAttributes().get(LORE), is(20));
        assertThat(character.getAttributes().get(MENTAL_POWER), is(10));
        assertThat(character.getAttributes().get(SPIRITUAL_POWER), is(63));
    }
    ...
    private void level87Upgrade() {
        ...
        assertThat(character.getAttributes().get(LORE), is(20));
        assertThat(character.getAttributes().get(MENTAL_POWER), is(10));
        assertThat(character.getAttributes().get(SPIRITUAL_POWER), is(69));
    }
    ...
    private void level90Upgrade() {
        ...
        assertThat(character.getAttributes().get(LORE), is(20));
        assertThat(character.getAttributes().get(MENTAL_POWER), is(10));
        assertThat(character.getAttributes().get(SPIRITUAL_POWER), is(75));
        // and
        assertThat(character.getSoulChips().size(), is(1));
        // and
        ...
        assertThat(character.getTotalMagicPoint(), is(315));
    }
