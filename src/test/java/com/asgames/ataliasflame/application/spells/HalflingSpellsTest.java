...
@SpringBootTest
class HalflingSpellsTest extends RaceSpellsTestBase {
    ...
    private static final Map<Caste, SpellName[]> AVAILABLE_SPELLS = Map.ofEntries(
            ...
            Map.entry(WIZARD, new SpellName[]{FIREBALL, SPLITTING_WIND, WEAKENING, REGENERATION, WOUND_HEALING}),
            Map.entry(MAGE, new SpellName[]{FIREBALL, GLACIAL_BLOW, LIGHTNING_STRIKE, SPLITTING_WIND, STRENGTHENING, WEAKENING, CURE, HEALING_WAVE, REGENERATION, WOUND_HEALING, CALLING_ANIMALS, SUMMON_GUARDIAN}),
            Map.entry(WITCHMASTER, new SpellName[]{FIREBALL, GLACIAL_BLOW, INFERNO, LIGHTNING_STRIKE, SPLITTING_WIND, STRENGTHENING, POWER_DRAIN, SHACKLE, WEAKENING, CURE, HEALING_WAVE, POWER_OF_NATURE, REGENERATION, WOUND_HEALING, CALLING_ANIMALS, SUMMON_GUARDIAN}),
            Map.entry(AVATAR, new SpellName[]{FIREBALL, GLACIAL_BLOW, INFERNO, LIGHTNING_STRIKE, SPLITTING_WIND, WRATH_OF_NATURE, DIVINE_PROTECTION, STRENGTHENING, POWER_DRAIN, SHACKLE, WEAKENING, BREATH_OF_GOD, CURE, HEALING_WAVE, POWER_OF_NATURE, REGENERATION, WOUND_HEALING, CALLING_ANIMALS, SUMMON_GUARDIAN}),
            ...
            Map.entry(GRANDMASTER, new SpellName[]{FIREBALL, LIGHTNING_STRIKE, STRENGTHENING, WEAKENING, CURE, HEALING_WAVE, REGENERATION, WOUND_HEALING, CALLING_ANIMALS, SUMMON_GUARDIAN}),
            Map.entry(TITAN, new SpellName[]{FIREBALL, LIGHTNING_STRIKE, SPLITTING_WIND, STRENGTHENING, SHACKLE, WEAKENING, CURE, HEALING_WAVE, REGENERATION, WOUND_HEALING, CALLING_ANIMALS, SUMMON_GUARDIAN}),
            ...
            Map.entry(FREE_SOUL, new SpellName[]{FIREBALL, INFERNO, LIGHTNING_STRIKE, SOUL_OUTBURST, SPLITTING_WIND, WRATH_OF_NATURE, PROTECTIVE_HAND_OF_NATURE, SOUL_CONNECTION, STRENGTHENING, SHACKLE, SOUL_STRIKE, CURE, HEALING_WAVE, POWER_OF_NATURE, REGENERATION, SOUL_POWER, WOUND_HEALING, CALLING_ANIMALS, CALLING_THE_SOULS, SUMMON_GUARDIAN}),
            ...
            Map.entry(ATALIAS_PRIEST, new SpellName[]{FIREBALL, GLACIAL_BLOW, INFERNO, LIGHTNING_STRIKE, SPLITTING_WIND, WRATH_OF_NATURE, DIVINE_PROTECTION, PROTECTIVE_HAND_OF_NATURE, STRENGTHENING, POWER_DRAIN, SHACKLE, WEAKENING, BREATH_OF_GOD, CURE, HEALING_WAVE, HEALING_WORD, POWER_OF_NATURE, REGENERATION, WOUND_HEALING, CALLING_ANIMALS, SUMMON_GUARDIAN}),
            Map.entry(MONK, new SpellName[]{DIVINE_PROTECTION, HEALING_WAVE, HEALING_WORD, WOUND_HEALING, FRIEND_IN_NEED}),
            Map.entry(PRIEST, new SpellName[]{FIREBALL, SPLITTING_WIND, DIVINE_PROTECTION, STRENGTHENING, SHACKLE, BREATH_OF_GOD, CURE, HEALING_WAVE, HEALING_WORD, POWER_OF_NATURE, REGENERATION, WOUND_HEALING, CALLING_ANIMALS, FRIEND_IN_NEED}),
            Map.entry(HIERARCH, new SpellName[]{FIREBALL, LIGHTNING_STRIKE, SPLITTING_WIND, DIVINE_PROTECTION, PROTECTIVE_HAND_OF_NATURE, STRENGTHENING, SHACKLE, WEAKENING, BREATH_OF_GOD, CURE, HEALING_WAVE, HEALING_WORD, POWER_OF_NATURE, REGENERATION, WOUND_HEALING, CALLING_ANIMALS, FRIEND_IN_NEED, SUMMON_GUARDIAN}),
            Map.entry(ARCHANGEL, new SpellName[]{FIREBALL, GLACIAL_BLOW, INFERNO, LIGHTNING_STRIKE, SPLITTING_WIND, WRATH_OF_NATURE, DIVINE_PROTECTION, PROTECTIVE_HAND_OF_NATURE, STRENGTHENING, SHACKLE, WEAKENING, BREATH_OF_GOD, CURE, HEALING_WAVE, HEALING_WORD, POWER_OF_NATURE, REGENERATION, WOUND_HEALING, CALLING_ANIMALS, FRIEND_IN_NEED, SUMMON_GUARDIAN}),
            Map.entry(SAGE, new SpellName[]{FIREBALL, GLACIAL_BLOW, INFERNO, LIGHTNING_STRIKE, SPLITTING_WIND, WRATH_OF_NATURE, STRENGTHENING, POWER_DRAIN, SHACKLE, WEAKENING, CURE, HEALING_WAVE, POWER_OF_NATURE, REGENERATION, WOUND_HEALING, CALLING_ANIMALS, SUMMON_GUARDIAN}),
            Map.entry(CHAMPION, new SpellName[]{FIREBALL, INFERNO, LIGHTNING_STRIKE, SOUL_OUTBURST, PROTECTIVE_HAND_OF_NATURE, SOUL_CONNECTION, STRENGTHENING, SOUL_STRIKE, WEAKENING, CURE, HEALING_WAVE, POWER_OF_NATURE, REGENERATION, SOUL_POWER, WOUND_HEALING, CALLING_ANIMALS, CALLING_THE_SOULS}),
            ...
            Map.entry(SHAMAN, new SpellName[]{FIREBALL, GLACIAL_BLOW, LIGHTNING_STRIKE, SPLITTING_WIND, WRATH_OF_NATURE, DIVINE_PROTECTION, PROTECTIVE_HAND_OF_NATURE, STRENGTHENING, POWER_DRAIN, SHACKLE, WEAKENING, BREATH_OF_GOD, CURE, HEALING_WAVE, HEALING_WORD, POWER_OF_NATURE, REGENERATION, WOUND_HEALING, CALLING_ANIMALS, SUMMON_GUARDIAN}),
            Map.entry(SAINT, new SpellName[]{FIREBALL, GLACIAL_BLOW, INFERNO, LIGHTNING_STRIKE, SPLITTING_WIND, WRATH_OF_NATURE, DIVINE_PROTECTION, PROTECTIVE_HAND_OF_NATURE, STRENGTHENING, SHACKLE, WEAKENING, BREATH_OF_GOD, CURE, HEALING_WAVE, HEALING_WORD, POWER_OF_NATURE, REGENERATION, WOUND_HEALING, CALLING_ANIMALS, FRIEND_IN_NEED, SUMMON_GUARDIAN}),
            Map.entry(CHARLATAN, new SpellName[]{FIREBALL, GLACIAL_BLOW, INFERNO, LIGHTNING_STRIKE, SOUL_OUTBURST, SPLITTING_WIND, WRATH_OF_NATURE, PROTECTIVE_HAND_OF_NATURE, STRENGTHENING, POWER_DRAIN, SHACKLE, SOUL_STRIKE, WEAKENING, CURE, HEALING_WAVE, POWER_OF_NATURE, REGENERATION, SOUL_POWER, WOUND_HEALING, CALLING_ANIMALS, CALLING_THE_SOULS, SUMMON_GUARDIAN}),
            Map.entry(APOSTLE, new SpellName[]{FIREBALL, LIGHTNING_STRIKE, SOUL_OUTBURST, SPLITTING_WIND, WRATH_OF_NATURE, DIVINE_PROTECTION, PROTECTIVE_HAND_OF_NATURE, SOUL_CONNECTION, STRENGTHENING, SHACKLE, SOUL_STRIKE, BREATH_OF_GOD, CURE, HEALING_WAVE, HEALING_WORD, POWER_OF_NATURE, REGENERATION, SOUL_POWER, WOUND_HEALING, CALLING_ANIMALS, CALLING_THE_SOULS, FRIEND_IN_NEED, SUMMON_GUARDIAN}),
            Map.entry(CRUSADER, new SpellName[]{FIREBALL, INFERNO, LIGHTNING_STRIKE, SPLITTING_WIND, DIVINE_PROTECTION, STRENGTHENING, SHACKLE, BREATH_OF_GOD, CURE, HEALING_WAVE, HEALING_WORD, POWER_OF_NATURE, REGENERATION, WOUND_HEALING, CALLING_ANIMALS, FRIEND_IN_NEED}),
            Map.entry(BARBARIAN, new SpellName[]{FIREBALL, GLACIAL_BLOW, LIGHTNING_STRIKE, SPLITTING_WIND, WRATH_OF_NATURE, PROTECTIVE_HAND_OF_NATURE, STRENGTHENING, SHACKLE, WEAKENING, CURE, HEALING_WAVE, POWER_OF_NATURE, REGENERATION, WOUND_HEALING, CALLING_ANIMALS}),
            Map.entry(WITCH_DOCTOR, new SpellName[]{FIREBALL, GLACIAL_BLOW, INFERNO, LIGHTNING_STRIKE, SPLITTING_WIND, WRATH_OF_NATURE, PROTECTIVE_HAND_OF_NATURE, STRENGTHENING, POWER_DRAIN, SHACKLE, WEAKENING, CURE, HEALING_WAVE, POWER_OF_NATURE, REGENERATION, WOUND_HEALING, CALLING_ANIMALS, SUMMON_GUARDIAN})
    );
}